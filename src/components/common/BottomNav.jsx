...
const BottomNav = () => {
  ...
  return (
    <nav className="z-app-navigation fixed bottom-0 left-0 right-0 bg-base-100/95 backdrop-blur-xl border-t border-base-300/80 lg:hidden safe-area-bottom shadow-[0_-8px_24px_rgba(15,23,42,0.08)]">
